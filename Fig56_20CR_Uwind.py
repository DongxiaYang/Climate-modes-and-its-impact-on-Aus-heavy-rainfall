...
for i in range(1950,2015,1):
    filelist.append(f'/g/data/ua8/LE_models/20CRv3/mean_daily/uwnd/uwnd.{i}.nc')
ds1=xr.open_mfdataset(filelist,combine='by_coords')
ds=ds1['uwnd'].loc[:,850,-45:20,100:160]
...
filename = "/g/data/w40/dy9345/MJO/"+'20cr_mean_Uano_elninomon_1950_2014.nc'
...
outf=xr.merge([U_9,Ucli],join='inner').load()
filename = "/g/data/w40/dy9345/MJO/"+'20cr_mean_Uano_laninamon_1950_2014.nc'
outf.to_netcdf(filename, 'w')